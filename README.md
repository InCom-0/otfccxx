...
[otfccxx](https://github.com/InCom-0/otfccxx) packages both font subsetting capability from harfbuzz-subset and some common aspects of font modifications (notably adjustments of font size, font contours and advance widths) enabled through the underlying font data model found in otfcc.
